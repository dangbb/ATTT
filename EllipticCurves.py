...
try:
    ...
    curve = ellipticCurves(1 + 9, 10 + 2, 41, True)
    curve.findAllPoint()

    for i in range(1, 40):
        try:
            print(i, curve.mulFaster((36, 40), i))
        except Exception as e:
            print(e)

    curve = ellipticCurves(1 + 9, 10 + 2, 83, True)
    curve.findAllPoint()

    for i in range(1, 98):
        try:
            print(i, curve.mulFaster((0, 26), i))
        except Exception as e:
            print(e)

    curve = ellipticCurves(1 + 9, 10 + 2, 127, True)
    curve.findAllPoint()

    for i in range(1, 113):
        try:
            print(i, curve.mulFaster((3, 14), i))
        except Exception as e:
            print(e)

    # curve.ElGamal_encode_and_decode((443, 253), 85, (0, 376), 113)
